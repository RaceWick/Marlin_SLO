...
//
  ...
  //#define FAN1_PIN                   9   // Remove the fan signal on pin P2_04 (example: SKR 1.4 Turbo HE1 plug)
...
//
  ...
  #define COOLER_MINTEMP           -3  // (°C)
  #define COOLER_MAXTEMP           35  // (°C)
  #define COOLER_DEFAULT_TEMP      10  // (°C)
  ...
  #define TEMP_COOLER_PIN         14 // Laser/Cooler temperature sensor pin. ADC is required.
  #define COOLER_FAN                  // Enable a fan on the cooler, Fan# 0,1,2,3 etc.
  #define COOLER_FAN_INDEX         0  // FAN number 0, 1, 2 etc. e.g.
  #if ENABLED(COOLER_FAN)
    #define COOLER_FAN_BASE      150  // Base Cooler fan PWM (0-255); turns on when Cooler temperature is above the target
    #define COOLER_FAN_FACTOR     30  // PWM increase per °C above target
  #endif
#endif
...
#define CASE_LIGHT_ENABLE
  ...
  #define CASE_LIGHT_DEFAULT_BRIGHTNESS 240   // Set default power-up brightness (0-255, requires PWM pin)
 ...
 */
#define DEFAULT_STEPPER_DEACTIVE_TIME 100000000
...
#define BACKLASH_COMPENSATION
  ...
  #define BACKLASH_DISTANCE_MM { 0.2, 0.2, 0 } // (linear=mm, rotational=°) One value for each linear axis
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 25*60, 25*60, 2*60, 2*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define PAUSE_PARK_RETRACT_FEEDRATE         0.4  // (mm/s) Initial retract feedrate.
...
#define LASER_FEATURE
  ...
  //#define CUTTER_POWER_RELATIVE              // Set speed proportional to [SPEED_POWER_MIN...SPEED_POWER_MAX]
    ...
    #define LASER_TEST_PULSE_MIN        1000   // (ms) Used with Laser Control Menu
    #define LASER_TEST_PULSE_MAX       10000   // (ms) Caution: Menu may not show more than 3 characters
    ...
    */
    #define LASER_SAFETY_TIMEOUT_MS     1000000   // (ms)
...
//#define NO_VOLUMETRICS
  ...
  #define VOLUMETRIC_EXTRUDER_LIMIT
     ...
     */
    #define DEFAULT_VOLUMETRIC_EXTRUDER_LIMIT 3.50      // (mm^3/sec)
  #endif
#endif
...
#define CUSTOM_MENU_MAIN
  ...
  #define CUSTOM_MENU_MAIN_SCRIPT_DONE "Preheat Initialized"
  ...
  #define MAIN_MENU_ITEM_1_DESC "Preheat for Alginate/FRESH"
  #define MAIN_MENU_ITEM_1_GCODE "M104 S37 \nM193 S10"
